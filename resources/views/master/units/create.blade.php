...
@section('content')
    <div class="container-fluid px-0 px-lg-3">
        <header
            ...
            <div>
                <h1 class="fw-bold mb-1">Tambah Satuan</h1>
                <p class="text-muted mb-0">Masukkan informasi satuan yang akan digunakan.</p>
            </div>
                ...
                <form action="{{ route('units.store') }}" method="POST" class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                            class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: Kilogram" required>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="symbol" name="symbol" value="{{ old('symbol') }}"
                            class="form-control @error('symbol') is-invalid @enderror" placeholder="Contoh: kg" required>
                        @error('symbol')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
