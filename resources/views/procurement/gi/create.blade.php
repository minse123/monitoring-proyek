...
@section('content')
    <div class="container-fluid px-0 px-lg-3">
        <header
            ...
            <div>
                <h1 class="fw-bold mb-1">Tambah Goods Issue</h1>
                <p class="text-muted mb-0">Catat pengeluaran material dari gudang untuk kebutuhan proyek.</p>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-lg-5">
                @include('procurement.gi.partials.form', [
                    'action' => route('procurement.goods-issues.store'),
                    'method' => null,
                    'goodsIssue' => null,
                    'projects' => $projects,
                    'materials' => $materials,
