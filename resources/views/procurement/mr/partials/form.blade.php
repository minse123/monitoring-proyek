...
<form action="{{ $action }}" method="POST" class="row g-4" data-items-container data-next-index="{{ $nextIndex }}">
    ...
    <div class="col-md-4">
        ...
        <input type="text" id="code" name="code" value="{{ old('code', $requestModel->code ?? '') }}"
            class="form-control @error('code') is-invalid @enderror" placeholder="Contoh: MR-001" required>
        @error('code')
